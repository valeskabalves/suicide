...
# Filtrar os dados para incluir apenas os anos de 1955 a 2015
...
renderPlot({
  ...
  ggplot(summary_data, aes(x = reorder(geo, suicide_total), y = suicide_total, fill=geo)) +
...
ggplot(filtered_data %>% 
       ...
       aes(x = time, y = mean_suicide_total, color = geo)) +
  geom_line() +
  scale_color_manual(values = custom_colors) +
